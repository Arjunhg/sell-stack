  ...
  return (
    <div className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        ...
        >
          <motion.h1 
            className="text-4xl font-bold tracking-tight sm:text-6xl text-primary"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link
              href="#contact"
              className="animated-outline rounded-md bg-gradient-to-r from-primary to-primary-light px-6 py-3 text-sm font-semibold button-text shadow-sm hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 hover:scale-105"
            >
              Sell My Licenses
            </Link>
            <Link
